...
+ 同类投影点尽可能近：同类投影点的协方差尽可能小
  + $\boldsymbol{w}^{T}\boldsymbol{\Sigma}_{0}\boldsymbol{w}\boldsymbol{w}^{T}\boldsymbol{\Sigma}_{1}\boldsymbol{w}$尽可能小
+ 异类投影点尽可能远离：类中心之间的距离尽可能大
  + $\left\Vert \boldsymbol{w}^{T}\boldsymbol{\mu}_{0}-\boldsymbol{w}^{T}\boldsymbol{\mu}_{1}\right\Vert ^{2}$尽可能大
